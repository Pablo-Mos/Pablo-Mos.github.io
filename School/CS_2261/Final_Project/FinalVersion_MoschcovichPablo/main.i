...
void goToStart()
{
    (*(volatile unsigned short *)0x400000A) = (1 << 7) | (0 << 14) | ((0) << 2) | ((31) << 8);
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 9);

    DMANow(3, startScreenPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, startScreenTiles, &((charblock *)0x6000000)[0], 14976 / 2);
...
void goToInstructions()
{
    ...
    DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[0], 27072 / 2);
...
void goToGame()
{
    ...
    *(volatile unsigned short *)0x4000106 = 3 | (1 << 7) | (1 << 6);
    ...
    (*(volatile unsigned short *)0x400000C) = (0 << 7) | (1 << 14) | ((0) << 2) | ((screenBlock) << 8);
    (*(volatile unsigned short *)0x4000008) = (0 << 7) | (1 << 14) | ((1) << 2) | ((screenBlock2) << 8);

    (*(volatile unsigned short *)0x04000012) = vOff;
    (*(volatile unsigned short *)0x04000010) = hOff;
    (*(volatile unsigned short *)0x0400001A) = vOff;
    (*(volatile unsigned short *)0x04000018) = hOff2 / 2;

    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8) | (1 << 10) | (1 << 12);

    DMANow(3, gameScreenPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, gameScreenTiles, &((charblock *)0x6000000)[0], 8096 / 2);
    DMANow(3, gameScreenMap, &((screenblock *)0x6000000)[28], 8192 / 2);

    DMANow(3, gameScreen2Tiles, &((charblock *)0x6000000)[1], 256 / 2);
    DMANow(3, gameScreen2Map, &((screenblock *)0x6000000)[24], 8192 / 2);
...
void game()
{
    if (hOff > 256 && screenBlock2 < 26)
    {
        screenBlock2++;
        hOff -= 256;
        (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((screenBlock2) << 8) | (1 << 14) | (0 << 7);
    }
    ...
    if (hOff2 > 256 && screenBlock < 30)
    {
        screenBlock++;
        hOff2 -= 256;
        (*(volatile unsigned short *)0x400000C) = ((0) << 2) | ((screenBlock) << 8) | (1 << 14) | (0 << 7);
    }
...
void goToPause()
{
    ...
    *(volatile unsigned short *)0x4000106 = (0 << 7);
    ...
    DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 12608 / 2);
...
void goToWin()
{
    ...
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 10752 / 2);
...
void goToLose()
{
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 9792 / 2);
...
void showLives()
{
    shadowOAM[1].attr0 = 5 | (0 << 13) | (1 << 14);
    shadowOAM[1].attr1 = 240 - 35 | (1 << 14);
    shadowOAM[1].attr2 = ((0) << 12) | (((lives - 1) + 5)*32 + (20));
}

void showScore()
{
    shadowOAM[2].attr0 = 3 | (0 << 13) | (0 << 14);
    shadowOAM[2].attr1 = 240 - 37 - 40 | (1 << 14);
    shadowOAM[2].attr2 = ((0) << 12) | ((4)*32 + (26));
    shadowOAM[3].attr0 = 5 | (0 << 13) | (2 << 14);
    shadowOAM[3].attr1 = 240 - 25 - 40 | (0 << 14);
    shadowOAM[3].attr2 = ((0) << 12) | ((20)*32 + (28));
    shadowOAM[4].attr0 = 4 | (0 << 13) | (2 << 14);
    shadowOAM[4].attr1 = 240 - 21 - 40 | (0 << 14);
    shadowOAM[4].attr2 = ((0) << 12) | ((2 * (pts / 10))*32 + (28));
    shadowOAM[5].attr0 = 4 | (0 << 13) | (2 << 14);
    shadowOAM[5].attr1 = 240 - 13 - 40 | (0 << 14);
    shadowOAM[5].attr2 = ((0) << 12) | ((2 * (pts % 10))*32 + (28));
}

void showScoreEnd()
{
    shadowOAM[125].attr0 = 78 | (0 << 13) | (0 << 14);
    shadowOAM[125].attr1 = 134 | (1 << 14);
    shadowOAM[125].attr2 = ((0) << 12) | ((4)*32 + (26));
    shadowOAM[126].attr0 = 80 | (0 << 13) | (2 << 14);
    shadowOAM[126].attr1 = 146 | (0 << 14);
    shadowOAM[126].attr2 = ((0) << 12) | ((20)*32 + (28));
    shadowOAM[127].attr0 = 79 | (0 << 13) | (2 << 14);
    shadowOAM[127].attr1 = 150 | (0 << 14);
    shadowOAM[127].attr2 = ((0) << 12) | ((2 * (pts / 10))*32 + (28));
    shadowOAM[124].attr0 = 79 | (0 << 13) | (2 << 14);
    shadowOAM[124].attr1 = 158 | (0 << 14);
    shadowOAM[124].attr2 = ((0) << 12) | ((2 * (pts % 10))*32 + (28));
}

void showAmmo()
{
    shadowOAM[6].attr0 = 5 | (0 << 13) | (0 << 14);
    shadowOAM[6].attr1 = 8 | (0 << 14);
    shadowOAM[6].attr2 = ((0) << 12) | ((1)*32 + (22));
    shadowOAM[7].attr0 = 5 | (0 << 13) | (2 << 14);
    shadowOAM[7].attr1 = 8 + 8 | (0 << 14);
    shadowOAM[7].attr2 = ((0) << 12) | ((20)*32 + (28));

    shadowOAM[8].attr0 = 4 | (0 << 13) | (2 << 14);
    shadowOAM[8].attr1 = 8 + 8 + 4 | (0 << 14);
    shadowOAM[8].attr2 = ((0) << 12) | ((2 * (numBullets / 10))*32 + (28));
    shadowOAM[9].attr0 = 4 | (0 << 13) | (2 << 14);
    shadowOAM[9].attr1 = 8 + 8 + 8 + 4 | (0 << 14);
    shadowOAM[9].attr2 = ((0) << 12) | ((2 * (numBullets % 10))*32 + (28));
}
...
void showWeapons()
{
    ...
    {
        shadowOAM[10].attr0 = 5 | (0 << 13) | (0 << 14);
        shadowOAM[10].attr1 = 56 - 8 | (0 << 14);
        shadowOAM[10].attr2 = ((0) << 12) | ((3)*32 + (20));
    }
    else
    ...
    if (currWeapon == KNIFE)
    {
        shadowOAM[11].attr0 = 5 | (0 << 13) | (0 << 14);
        shadowOAM[11].attr1 = 56 + 2 | (0 << 14);
        shadowOAM[11].attr2 = ((0) << 12) | ((3)*32 + (21));
    }
    else
    ...
    if (currWeapon == GUN)
    {
        shadowOAM[12].attr0 = 5 | (0 << 13) | (0 << 14);
        shadowOAM[12].attr1 = 56 + 9 | (0 << 14);
        shadowOAM[12].attr2 = ((0) << 12) | ((3)*32 + (22));
    }
    else
        shadowOAM[12].attr0 = (2 << 8);


    shadowOAM[13].attr0 = 5 | (0 << 13) | (0 << 14);
    shadowOAM[13].attr1 = 56 - 8 | (0 << 14);
    shadowOAM[13].attr2 = ((0) << 12) | ((4)*32 + (20));
    shadowOAM[14].attr0 = 5 | (0 << 13) | (0 << 14);
    shadowOAM[14].attr1 = 56 + 2 | (0 << 14);
    shadowOAM[14].attr2 = ((0) << 12) | ((4)*32 + (21));
    shadowOAM[15].attr0 = 5 | (0 << 13) | (0 << 14);
    shadowOAM[15].attr1 = 56 + 9 | (0 << 14);
    shadowOAM[15].attr2 = ((0) << 12) | ((4)*32 + (22));
}
...
void showTime()
{
    ...
    timerAniCounter++;
    shadowOAM[16].attr0 = y | (0 << 13) | (0 << 14);
    shadowOAM[16].attr1 = x - 4 | (1 << 14);
    shadowOAM[16].attr2 = ((0) << 12) | ((2 * timerCurFrame)*32 + (30));

    shadowOAM[17].attr0 = y | (0 << 13) | (2 << 14);
    shadowOAM[17].attr1 = x + 8 | (0 << 14);
    shadowOAM[17].attr2 = ((0) << 12) | ((2 * time_m_1s)*32 + (28));

    shadowOAM[18].attr0 = y | (0 << 13) | (2 << 14);
    shadowOAM[18].attr1 = x + 8 + 8 | (0 << 14);
    shadowOAM[18].attr2 = ((0) << 12) | ((20)*32 + (28));

    shadowOAM[19].attr0 = y | (0 << 13) | (2 << 14);
    shadowOAM[19].attr1 = x + 8 + 8 + 4 | (0 << 14);
    shadowOAM[19].attr2 = ((0) << 12) | ((2 * time_s_10s)*32 + (28));

    shadowOAM[20].attr0 = y | (0 << 13) | (2 << 14);
    shadowOAM[20].attr1 = x + 8 + 8 + 8 + 4 | (0 << 14);
    shadowOAM[20].attr2 = ((0) << 12) | ((2 * time_s_1s)*32 + (28));
}
