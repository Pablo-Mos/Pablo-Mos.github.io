...
# 1 "instructions.h" 1
# 22 "instructions.h"
extern const unsigned short instructionsTiles[2496];
...
void goToInstructions()
{
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 4992 / 2);
...
void showLives()
{
    shadowOAM[15].attr0 = 2 | (0 << 13) | (1 << 14);
    shadowOAM[15].attr1 = 240 - 70 | (3 << 14);
    shadowOAM[15].attr2 = ((0) << 12) | (((lives - 1) * 4 + 8)*32 + (20));
}

void showScore()
{
    shadowOAM[16].attr0 = 2 | (0 << 13) | (1 << 14);
    shadowOAM[16].attr1 = 240 - 70 | (3 << 14);
    shadowOAM[16].attr2 = ((0) << 12) | ((22)*32 + (20));

    shadowOAM[17].attr0 = 17 | (0 << 13) | (0 << 14);
    shadowOAM[17].attr1 = 240 - 28 | (1 << 14);
    if (pts < 10)
        shadowOAM[17].attr2 = ((0) << 12) | ((2 * pts)*32 + (28));
    else
    {
        shadowOAM[17].attr2 = ((0) << 12) | ((2 * (pts / 10))*32 + (28));
        shadowOAM[18].attr0 = 17 | (0 << 13) | (0 << 14);
        shadowOAM[18].attr1 = 240 - 20 | (1 << 14);
        shadowOAM[18].attr2 = ((0) << 12) | ((2 * (pts % 10))*32 + (28));
    }
}
