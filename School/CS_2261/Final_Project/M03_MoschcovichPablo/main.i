...
# 1 "bg.h" 1
# 22 "bg.h"
extern const unsigned short bgTiles[1376];
...
# 1 "instructions.h" 1
# 22 "instructions.h"
extern const unsigned short instructionsTiles[3344];
...
void goToStart()
{
    ...
    DMANow(3, bgTiles, &((charblock *)0x6000000)[0], 2752 / 2);
...
void goToInstructions()
{
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 6688 / 2);
...
void goToGame()
{
    ...
    DMANow(3, gameScreenTiles, &((charblock *)0x6000000)[0], 1088 / 2);
    DMANow(3, gameScreenMap, &((screenblock *)0x6000000)[28], 4096 / 2);
...
void goToPause()
{
    ...
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 1632 / 2);
...
void goToLose()
{
    ...
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 1664 / 2);
...
void showLives()
{
    shadowOAM[1].attr0 = 2 | (0 << 13) | (1 << 14);
    shadowOAM[1].attr1 = 240 - 70 | (3 << 14);
    shadowOAM[1].attr2 = ((0) << 12) | (((lives - 1) * 4 + 8)*32 + (20));
}

void showScore()
{
    shadowOAM[2].attr0 = 2 | (0 << 13) | (1 << 14);
    shadowOAM[2].attr1 = 240 - 70 | (3 << 14);
    shadowOAM[2].attr2 = ((0) << 12) | ((22)*32 + (20));

    shadowOAM[3].attr0 = 17 | (0 << 13) | (0 << 14);
    shadowOAM[3].attr1 = 240 - 28 | (1 << 14);
    if (pts < 10)
        shadowOAM[3].attr2 = ((0) << 12) | ((2 * pts)*32 + (28));
    else
    {
        shadowOAM[3].attr2 = ((0) << 12) | ((2 * (pts / 10))*32 + (28));
        shadowOAM[4].attr0 = 17 | (0 << 13) | (0 << 14);
        shadowOAM[4].attr1 = 240 - 20 | (1 << 14);
...
void showAmmo()
{
    shadowOAM[5].attr0 = 4 | (0 << 13) | (1 << 14);
    shadowOAM[5].attr1 = 8 | (3 << 14);
    shadowOAM[5].attr2 = ((0) << 12) | ((20)*32 + (20));

    shadowOAM[6].attr0 = 4 | (0 << 13) | (0 << 14);
    shadowOAM[6].attr1 = 48 | (1 << 14);
    if (numBullets < 10)
    {
        shadowOAM[6].attr2 = ((0) << 12) | ((2 * numBullets)*32 + (28));
        shadowOAM[7].attr0 = (2 << 8);
    }
    else
    {
        shadowOAM[6].attr2 = ((0) << 12) | ((2 * (numBullets / 10))*32 + (28));
        shadowOAM[7].attr0 = 4 | (0 << 13) | (0 << 14);
        shadowOAM[7].attr1 = 56 | (1 << 14);
        shadowOAM[7].attr2 = ((0) << 12) | ((2 * (numBullets % 10))*32 + (28));
    }
}

void showWeapons()
{
    shadowOAM[8].attr0 = 18 | (0 << 13) | (1 << 14);
    shadowOAM[8].attr1 = 7 | (3 << 14);
    shadowOAM[8].attr2 = ((0) << 12) | ((28)*32 + (20));
    if (numWeapons > 0)
    {
        shadowOAM[9].attr0 = 17 | (0 << 13) | (0 << 14);
        shadowOAM[9].attr1 = 56 | (0 << 14);
        if (currWeapon == SHIELD)
            shadowOAM[9].attr2 = ((0) << 12) | ((0)*32 + (12));
        else if (currWeapon == KNIFE)
            shadowOAM[9].attr2 = ((0) << 12) | ((0)*32 + (13));
        else if (currWeapon == GUN)
            shadowOAM[9].attr2 = ((0) << 12) | ((0)*32 + (14));
    }
}
