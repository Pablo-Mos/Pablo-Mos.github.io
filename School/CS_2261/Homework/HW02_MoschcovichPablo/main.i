...
void update() {
 ...
 if (tCol > 240 - 20) {
  ...
  tCol = (240 - 1) - (20);
    ...
    if(lvl == 3 && ((!(~oldButtons & (1<<3))) && (~buttons & ((1<<3))))){
        initialize();
    }
}
...
void drawChar1(int tCol,int tRow){
    drawRect(tCol+5,tRow+50,10,10,((20) | (20)<<5 | (20)<<10));
    drawRect(tCol+12,tRow+52,2,2,0);
    drawRect(tCol+12,tRow+52,1,1,((31) | (31)<<5 | (31)<<10));
    drawRect(tCol+6,tRow+52,2,2,0);
    drawRect(tCol+6,tRow+52,1,1,((31) | (31)<<5 | (31)<<10));
    drawRect(tCol+12,tRow+46,2,4,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+6,tRow+46,2,4,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+8,tRow+56,4,2,0);
    drawRect(tCol+0,tRow+60,20,20,((20) | (20)<<5 | (20)<<10));
    drawRect(tCol+6,tRow+65,8,8,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+8,tRow+67,4,4,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+0,tRow+60,5,10,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+15,tRow+60,5,10,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+0,tRow+70,5,5,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+15,tRow+70,5,5,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+0,tRow+80,5,5,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+0,tRow+85,5,2,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+15,tRow+80,5,5,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+15,tRow+85,5,2,((31) | (10)<<5 | (16)<<10));
}

void delChar1(int tCol,int tRow){
    drawRect(tCol+5,tRow+50,10,10,0);
    drawRect(tCol+12,tRow+46,2,4,0);
    drawRect(tCol+6,tRow+46,2,4,0);
    drawRect(tCol+0,tRow+60,20,20,0);
    drawRect(tCol+0,tRow+80,5,5,0);
    drawRect(tCol+0,tRow+85,5,2,0);
    drawRect(tCol+15,tRow+80,5,5,0);
    drawRect(tCol+15,tRow+85,5,2,0);
}
...
void drawChar2(int tCol,int tRow){
    ...
    drawRect(tCol+6,tRow+52,2,2,0);
    drawRect(tCol+6,tRow+52,1,1,((31) | (31)<<5 | (31)<<10));
    drawRect(tCol+12,tRow+42,2,8,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+6,tRow+42,2,8,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+8,tRow+56,4,2,0);
    drawRect(tCol+0,tRow+60,20,20,((20) | (20)<<5 | (20)<<10));
    drawRect(tCol+6,tRow+65,8,8,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+8,tRow+67,4,4,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+0,tRow+60,5,15,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+15,tRow+60,5,15,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+0,tRow+75,5,5,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+15,tRow+75,5,5,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+0,tRow+80,5,5,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+0,tRow+85,5,2,((31) | (10)<<5 | (16)<<10));
    drawRect(tCol+15,tRow+80,5,5,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+15,tRow+85,5,2,((31) | (10)<<5 | (16)<<10));
...
void delChar2(int tCol,int tRow){
    drawRect(tCol+5,tRow+50,10,10,0);
    drawRect(tCol+12,tRow+42,2,8,0);
    drawRect(tCol+6,tRow+42,2,8,0);
    drawRect(tCol+0,tRow+60,20,20,0);
    drawRect(tCol+6,tRow+65,8,8,0);
    drawRect(tCol+8,tRow+67,4,4,0);
    drawRect(tCol+0,tRow+80,5,5,0);
    drawRect(tCol+0,tRow+85,5,2,0);
    drawRect(tCol+15,tRow+80,5,5,0);
    drawRect(tCol+15,tRow+85,5,2,0);
...
void drawChar3(int tCol,int tRow){
    drawRect(tCol+5,tRow+50,10,10,((20) | (20)<<5 | (20)<<10));
    drawRect(tCol+12,tRow+52,2,2,0);
    drawRect(tCol+12,tRow+52,1,1,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+6,tRow+52,2,2,0);
    drawRect(tCol+6,tRow+52,1,1,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+12,tRow+34,2,16,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+6,tRow+34,2,16,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+8,tRow+56,4,2,0);
    drawRect(tCol+0,tRow+60,20,20,((20) | (20)<<5 | (20)<<10));
    drawRect(tCol+6,tRow+65,8,8,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+8,tRow+67,4,4,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+0,tRow+60,5,15,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+15,tRow+60,5,15,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+0,tRow+75,5,10,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+15,tRow+75,5,10,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+0,tRow+80,5,5,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+0,tRow+85,5,2,((31) | (0)<<5 | (0)<<10));
    drawRect(tCol+15,tRow+80,5,5,((25) | (10)<<5 | (31)<<10));
    drawRect(tCol+15,tRow+85,5,2,((31) | (0)<<5 | (0)<<10));
}

void delChar3(int tCol,int tRow){
    drawRect(tCol+5,tRow+50,10,10,0);
    drawRect(tCol+12,tRow+34,2,16,0);
    drawRect(tCol+6,tRow+34,2,16,0);
    drawRect(tCol+0,tRow+60,20,20,0);
    drawRect(tCol+0,tRow+60,5,15,0);
    drawRect(tCol+15,tRow+60,5,15,0);
    drawRect(tCol+0,tRow+75,5,10,0);
    drawRect(tCol+15,tRow+75,5,10,0);
    drawRect(tCol+0,tRow+80,5,5,0);
    drawRect(tCol+0,tRow+85,5,2,0);
    drawRect(tCol+15,tRow+80,5,5,0);
    drawRect(tCol+15,tRow+85,5,2,0);
...
void drawBase(){
    drawRect(0,160 -10,240,10,((22) | (11)<<5 | (6)<<10));
    drawRect(0,160 -15,240,5,((0) | (31)<<5 | (0)<<10));
}

void endScreen(){
    fillScreen(0);
    for(int i=0; i<=10; i++) {
        drawCircle(rand()%240,rand()%160,1,((31) | (0)<<5 | (31)<<10));
        drawCircle(rand()%240,rand()%160,1,((0) | (31)<<5 | (0)<<10));
        drawCircle(rand()%240,rand()%160,1,((0) | (31)<<5 | (31)<<10));
        drawCircle(rand()%240,rand()%160,1,((31) | (31)<<5 | (0)<<10));
        drawCircle(rand()%240,rand()%160,1,((31) | (0)<<5 | (0)<<10));
        drawCircle(rand()%240,rand()%160,1,((31) | (0)<<5 | (0)<<10));
    }
}
...
void drawStars(){
    for(int i=0; i<=1; i++) {
        setPixel(rand()%240,rand()%140,((31) | (31)<<5 | (31)<<10));
    }
    for(int i=0; i<=1; i++) {
        drawCircle(rand()%240,rand()%135,10,0);
    }
}
