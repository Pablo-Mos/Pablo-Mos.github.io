...
void goToStart()
{
    ...
    DMANow(3, bgTiles, &((charblock *)0x6000000)[0], 2720 / 2);
...
void goToGame()
{
    ...
    DMANow(3, gameScreenTiles, &((charblock *)0x6000000)[0], 832 / 2);
...
void goToGame2()
{
    ...
    DMANow(3, gameScreen2Tiles, &((charblock *)0x6000000)[0], 1120 / 2);
...
void showScore()
{
    ...
    shadowOAM[17].attr0 = 18 | (0 << 13) | (0 << 14);
    shadowOAM[17].attr1 = 240 - 32 | (1 << 14);
    if (pts < 10)
        shadowOAM[17].attr2 = ((0) << 12) | ((2 * pts)*32 + (28));
    else
    {
        shadowOAM[17].attr2 = ((0) << 12) | ((2 * (pts / 10))*32 + (28));
        shadowOAM[18].attr0 = 18 | (0 << 13) | (0 << 14);
        shadowOAM[18].attr1 = 240 - 25 | (1 << 14);
