...
void showScore()
{
    ...
    shadowOAM[17].attr0 = 17 | ATTR0_4BPP | ATTR0_SQUARE;
    shadowOAM[17].attr1 = SCREENWIDTH - 28 | ATTR1_SMALL;
    if (pts < 10)
        shadowOAM[17].attr2 = ATTR2_PALROW(0) | ATTR2_TILEID(28, 2 * pts);
    else
    {
        shadowOAM[17].attr2 = ATTR2_PALROW(0) | ATTR2_TILEID(28, 2 * (pts / 10));
        shadowOAM[18].attr0 = 17 | ATTR0_4BPP | ATTR0_SQUARE;
        shadowOAM[18].attr1 = SCREENWIDTH - 20 | ATTR1_SMALL;
