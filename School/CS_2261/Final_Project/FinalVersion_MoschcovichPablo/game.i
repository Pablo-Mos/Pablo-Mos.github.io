...
void initPlayer()
{
    ...
    player.worldRow = 10 + 160 / 2 - player.width / 2 + vOff;
    player.worldCol = 5;
...
void updateWeapon()
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        {
            shadowOAM[i + 21].attr0 = (0xFF & (weapon[i].worldRow - vOff)) | (0 << 13) | (0 << 14);
            shadowOAM[i + 21].attr1 = (0x1FF & (weapon[i].worldCol - pHoff())) | (0 << 14);
            if (weapon[i].type == GUN)
                shadowOAM[i + 21].attr2 = ((0) << 12) | ((2 + weapon[i].curFrame)*32 + (22));
            else if (weapon[i].type == KNIFE)
                shadowOAM[i + 21].attr2 = ((0) << 12) | ((2 + weapon[i].curFrame)*32 + (21));
            else if (weapon[i].type == SHIELD)
                shadowOAM[i + 21].attr2 = ((0) << 12) | ((2 + weapon[i].curFrame)*32 + (20));
        }
        else
        {
            shadowOAM[i + 21].attr0 = (2 << 8);
        }
    }
}
...
void updateEnemy()
{
    ...
    for (int i = 0; i < 12; i++)
    {
        ...
        {
            shadowOAM[i + 3 + 21].attr0 = (0xFF & (enemy[i].worldRow - vOff)) | (0 << 13) | (2 << 14);
            if (enemy[i].hitFramesEnemy > 0)
            {
                (*(volatile unsigned short *)0x400004C) = (1 << 8) | (1 << 12);
                shadowOAM[i + 3 + 21].attr0 |= (1 << 12);
                enemy[i].hitFramesEnemy--;
            }
            shadowOAM[i + 3 + 21].attr1 = (0x1FF & (enemy[i].worldCol - pHoff())) | (2 << 14);
            if (enemy[i].shot2 && !hasCheat && !hasIce)
            {
                if (enemy[i].type == NORMAL)
                {
                    if (enemy[i].direction == 1)
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((12)*32 + (8));
                    else
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((12)*32 + (12));
                }
                else
                {
                    if (enemy[i].direction == 1)
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((28)*32 + (8));
                    else
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((28)*32 + (12));
                }
            }
            else
            {
                ...
                {
                    if (enemy[i].direction == 1)
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((enemy[i].curFrame * 4)*32 + (8));
                    else
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((enemy[i].curFrame * 4)*32 + (12));
                }
                else if (enemy[i].type == BOSS)
                {
                    if (enemy[i].direction == 1)
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((enemy[i].curFrame * 4 + 16)*32 + (8));
                    else
                        shadowOAM[i + 3 + 21].attr2 = ((0) << 12) | ((enemy[i].curFrame * 4 + 16)*32 + (12));
                }
...
void updateCoins()
{
    for (int i = 0; i < 12; i++)
    {
        ...
        {
            shadowOAM[i + 3 + 12 + 21].attr0 = (0xFF & (coin[i].worldRow - vOff + coin[i].rowDirection)) | (0 << 13) | (0 << 14);
            if (coin[i].type == NORMAL)
            {
                shadowOAM[i + 3 + 12 + 21].attr1 = (0x1FF & (coin[i].worldCol - pHoff())) | (1 << 14);
                shadowOAM[i + 3 + 12 + 21].attr2 = ((0) << 12) | ((2 * coin[i].curFrame)*32 + (24));
            }
            else if (coin[i].type == SPECIAL)
            {
                shadowOAM[i + 3 + 12 + 21].attr1 = (0x1FF & (coin[i].worldCol - pHoff())) | (0 << 14);
                shadowOAM[i + 3 + 12 + 21].attr2 = ((0) << 12) | ((coin[i].curFrame)*32 + (23));
            }
            else if (coin[i].type == ICE)
            {
                shadowOAM[i + 3 + 12 + 21].attr1 = (0x1FF & (coin[i].worldCol - pHoff())) | (1 << 14);
                shadowOAM[i + 3 + 12 + 21].attr2 = ((0) << 12) | ((2 * coin[i].curFrame)*32 + (18));
            }
...
void updateAmmo()
{
    for (int i = 0; i < 15; i++)
    {
        ...
        {
            shadowOAM[i + 3 + 12 + 12 + 21].attr0 = (0xFF & (ammo[i].worldRow - vOff)) | (0 << 13) | (0 << 14);
            shadowOAM[i + 3 + 12 + 12 + 21].attr1 = (0x1FF & (ammo[i].worldCol - pHoff())) | (0 << 14);
            shadowOAM[i + 3 + 12 + 12 + 21].attr2 = ((0) << 12) | ((ammo[i].curFrame)*32 + (22));
            ...
            shadowOAM[i + 3 + 12 + 12 + 21].attr0 = (2 << 8);
    }
}
...
void updateKey()
{
    ...
    if (!hasKey)
    {
        shadowOAM[3 + 12 + 12 + 15 + 5 + 30 + 21].attr0 = (0xFF & (key.worldRow - vOff)) | (0 << 13) | (2 << 14);
        shadowOAM[3 + 12 + 12 + 15 + 5 + 30 + 21].attr1 = (0x1FF & (key.worldCol - hOff)) | (0 << 14);
        shadowOAM[3 + 12 + 12 + 15 + 5 + 30 + 21].attr2 = ((0) << 12) | ((2 * key.curFrame)*32 + (26));
    }
    else
        shadowOAM[3 + 12 + 12 + 15 + 5 + 30 + 21].attr0 = (2 << 8);
...
void updateDoor()
{
    ...
    shadowOAM[1 + 3 + 12 + 12 + 15 + 5 + 30 + 21].attr0 = (0xFF & (door.worldRow - vOff)) | (0 << 13) | (2 << 14);
    shadowOAM[1 + 3 + 12 + 12 + 15 + 5 + 30 + 21].attr1 = (0x1FF & (door.worldCol - hOff)) | (2 << 14);
    shadowOAM[1 + 3 + 12 + 12 + 15 + 5 + 30 + 21].attr2 = ((0) << 12) | ((door.curFrame * 4)*32 + (16));
...
void updateBullet(ANISPRITE *b)
{
    ...
    if (b->active)
    {
        ...
        {
            ((screenblock *)0x6000000)[27].tilemap[((3) * (32) + (28))] = 0;
            ((screenblock *)0x6000000)[27].tilemap[((3) * (32) + (29))] = 0;
            ((screenblock *)0x6000000)[27].tilemap[((3) * (32) + (30))] = 0;
            ((screenblock *)0x6000000)[27].tilemap[((3) * (32) + (31))] = 0;
            b->active = 0;
            keyFall = 1;
        }
    }
...
void updateBulletEnemy(ANISPRITE *b)
{
    ...
    if (b->active)
    {
        if (b->direction == 1)
        {
            if (b->worldCol + b->cdel <= 1024 + hOff - 1)
            {
                b->worldCol += b->cdel;
            }
            else
...
void updatePlayer()
{
    ...
    if ((!(~(oldButtons) & ((1 << 2))) && (~buttons & ((1 << 2)))) && numWeapons > 1)
    {
        switchWeapons();
    }
    if (!ovrEnemyColl)
    ...
    if (currWeapon == GUN && (!(~(oldButtons) & ((1 << 0))) && (~buttons & ((1 << 0)))) && player.bulletTimer >= 10 && numBullets > 0)
    {
        fireBullet();
    ...
    if (currWeapon == KNIFE && (!(~(oldButtons) & ((1 << 0))) && (~buttons & ((1 << 0)))))
    {
        stabbing = 1;
        stabbingFrames = 0;
    }
    ...
    if (currWeapon == SHIELD && ((!(~(oldButtons) & ((1 << 0))) && (~buttons & ((1 << 0)))) || (~((*(volatile unsigned short *)0x04000130)) & ((1 << 0)))))
    {
        shielding = 1;
    }
    else
    ...
    if (((!(~(oldButtons) & ((1 << 1))) && (~buttons & ((1 << 1)))) || (~((*(volatile unsigned short *)0x04000130)) & ((1 << 1)))) && jumped == 0 && fallen == 0)
    {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 5))) && (player.worldCol > 0) && collisionCheck(collisionMap, 1024, player.worldCol, player.worldRow, player.width, player.height, -player.cdel, 0))
    {
        player.aniState = SPRITELEFT;
        player.worldCol -= player.cdel;

        if ((screenBlock2 > 24 || hOff > 0) && (player.worldCol - playerhOff <= 240 / 2))
        {
            hOff--;
            hOff2 -= (1 / 2);
        ...
        else if ((screenBlock2 > 24 || hOff > 0) && (player.worldCol - playerhOff - 1024 / 2 <= 240 / 2))
        {
            hOff--;
            hOff2 -= (1 / 2);
            playerhOff -= player.cdel;
    ...
    else if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 4))) && (player.worldCol + player.width - 1 < 1024 - 6) && collisionCheck(collisionMap, 1024, player.worldCol, player.worldRow, player.width, player.height, player.cdel, 0))
    {
        player.aniState = SPRITERIGHT;
        player.worldCol += player.cdel;
        if ((screenBlock2 < 27 || hOff < 32) && hOff + 240 <= 1024 && player.worldCol - playerhOff >= 240 / 2)
        {
    ...
    if (!jumped && collisionMap[((player.worldRow + player.height) * (1024) + (player.worldCol))] != 0 && collisionMap[((player.worldRow + player.height) * (1024) + (player.worldCol + (player.width / 2)))] != 0 && collisionMap[((player.worldRow + player.height) * (1024) + (player.worldCol + player.width - 1))] != 0)
        player.worldRow++;
}
...
void drawBullets()
{
    for (int i = 0; i < 5; i++)
    {
        if (bullets[i].active && onScreen(bullets[i]))
        {
            ...
            {
                shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr0 = (0xFF & (bullets[i].worldRow - vOff)) | (0 << 13) | (0 << 14);
                shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr1 = (0x1FF & (bullets[i].worldCol - pHoff())) | (0 << 14);
                shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr2 = ((0) << 12) | ((0)*32 + (20));
            }
            else
            {
                shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr0 = (0xFF & (bullets[i].worldRow - vOff)) | (0 << 13) | (0 << 14);
                shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr1 = (0x1FF & (bullets[i].worldCol - pHoff())) | (0 << 14);
                shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr2 = ((0) << 12) | ((1)*32 + (20));
            }
        }
        else
        {
            shadowOAM[i + 3 + 12 + 12 + 15 + 21].attr0 = (2 << 8);
        }
    }
}
...
void drawBulletsEnemy()
{
    for (int i = 0; i < 30; i++)
    {
        ...
        {
            shadowOAM[i + 3 + 12 + 12 + 15 + 5 + 21].attr0 = (0xFF & (enemyBullets[i].worldRow - vOff)) | (0 << 13) | (0 << 14);
            shadowOAM[i + 3 + 12 + 12 + 15 + 5 + 21].attr1 = (0x1FF & (enemyBullets[i].worldCol - pHoff())) | (0 << 14);
            shadowOAM[i + 3 + 12 + 12 + 15 + 5 + 21].attr2 = ((0) << 12) | ((0)*32 + (21));
        }
        else
        {
            shadowOAM[i + 3 + 12 + 12 + 15 + 5 + 21].attr0 = (2 << 8);
        }
    }
}
...
void fireBulletEnemy(ANISPRITE e)
{
    ...
    for (int i = 0; i < 30; i++)
    {
        if (!enemyBullets[i].active && e.active)
        {
            ...
            enemyBullets[i].worldCol = e.worldCol ;
            enemyBullets[i].height = 5;
            enemyBullets[i].width = 13;
            if (e.direction == -1)
            {
...
void drawPlayer()
{
    shadowOAM[0].attr0 = (0xFF & (player.worldRow - vOff)) | (0 << 13) | (2 << 14);
    ...
    shadowOAM[0].attr1 = (0x1FF & (player.worldCol - playerhOff)) | (2 << 14);
    if (jumped)
    {
        if (player.prevAniState == SPRITERIGHT || player.aniState == SPRITERIGHT)
            shadowOAM[0].attr2 = ((0) << 12) | ((12)*32 + (0));
        else if (player.prevAniState == SPRITELEFT || player.aniState == SPRITELEFT)
            shadowOAM[0].attr2 = ((0) << 12) | ((12)*32 + (4));
        if (timer % 2 == 0)
        {
            player.worldRow -= 2;
            jumpCount++;

            if (jumpCount == maxJump || (collisionMap[((player.worldRow - 1) * (1024) + (player.worldCol))] == 0 || collisionMap[((player.worldRow - 1) * (1024) + (player.worldCol + (player.width / 2)))] == 0 || collisionMap[((player.worldRow - 1) * (1024) + (player.worldCol + player.width - 1))] == 0))
            {
                jumped = 0;
                fallen = 1;
            }
    ...
    else if (collisionCheck(collisionMap, 1024, player.worldCol, player.worldRow + 2, player.width, player.height, 0, player.rdel))
        player.worldRow++;
    else if (fallen)
    {
        if (player.prevAniState == SPRITERIGHT || player.aniState == SPRITERIGHT)
    ...
    {
        if (player.prevAniState == SPRITERIGHT || player.aniState == SPRITERIGHT)
            shadowOAM[0].attr2 = ((0) << 12) | ((16)*32 + (0));
        else if (player.prevAniState == SPRITELEFT || player.aniState == SPRITELEFT)
            shadowOAM[0].attr2 = ((0) << 12) | ((16)*32 + (4));
    }

    else if (shielding)
    {
        if (player.prevAniState == SPRITERIGHT || player.aniState == SPRITERIGHT)
            shadowOAM[0].attr2 = ((0) << 12) | ((24)*32 + (0));
        else if (player.prevAniState == SPRITELEFT || player.aniState == SPRITELEFT)
            shadowOAM[0].attr2 = ((0) << 12) | ((24)*32 + (4));
    }
    else if (player.shot)
    {
        if (player.prevAniState == SPRITERIGHT || player.aniState == SPRITERIGHT)
        {
            if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 6))))
                shadowOAM[0].attr2 = ((0) << 12) | ((28)*32 + (0));
            else
                shadowOAM[0].attr2 = ((0) << 12) | ((20)*32 + (0));
        }
        else if (player.prevAniState == SPRITELEFT || player.aniState == SPRITELEFT)
        {
            if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 6))))
                shadowOAM[0].attr2 = ((0) << 12) | ((28)*32 + (4));
            else
                shadowOAM[0].attr2 = ((0) << 12) | ((20)*32 + (4));
        }
    }
    else if (player.prevAniState == SPRITERIGHT && player.aniState != SPRITERIGHT)
        shadowOAM[0].attr2 = ((0) << 12) | ((0)*32 + (0));
    else if (player.prevAniState == SPRITELEFT && player.aniState != SPRITELEFT)
        shadowOAM[0].attr2 = ((0) << 12) | ((0)*32 + (4));
    else if (player.aniState == SPRITERIGHT)
        shadowOAM[0].attr2 = ((0) << 12) | ((player.curFrame * 4)*32 + (0));
    else if (player.aniState == SPRITELEFT)
        shadowOAM[0].attr2 = ((0) << 12) | ((player.curFrame * 4)*32 + (4));
}

void updateCamera()
{
    if (player.worldRow > 256 / 2 + 16)
        vOff = 96;
    else
        vOff = 0;
}
...
{
    if ((a.worldRow + a.height - vOff >= 0 && a.worldRow - vOff <= 160) &&
        (a.worldCol + a.width - pHoff() >= 0 && a.worldCol - pHoff() <= 240))
        return 1;
    else
        return 0;
}
