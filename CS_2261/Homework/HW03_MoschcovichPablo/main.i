...
void goToStart() {
    fillScreen(((0) | (5)<<5 | (31)<<10));
    drawRect(38,25,164,34,0);
    drawRect(40,27,160,30,((0) | (19)<<5 | (31)<<10));
    drawString(47,37,"Welcome to WAVE CRASHER!",0);
    drawString(65,80,"choose a difficulty",((0) | (19)<<5 | (31)<<10));
    drawString(55,90,"& press START to begin",((0) | (19)<<5 | (31)<<10));

    if(dif == 10){
        drawString(45,120,"Easy",((31) | (31)<<5 | (31)<<10));
        drawString(100,120,"Medium",0);
        drawString(170,120,"Hard",0);
    }
    else if(dif == 5){
        drawString(45,120,"Easy",0);
        drawString(100,120,"Medium",((31) | (31)<<5 | (31)<<10));
        drawString(170,120,"Hard",0);
    }
    else{
        drawString(45,120,"Easy",0);
        drawString(100,120,"Medium",0);
        drawString(170,120,"Hard",((31) | (31)<<5 | (31)<<10));
    }
    drawRect(0,0,240,4,0);
    drawRect(0,0,4,160,0);
    drawRect(0,160 -4,240,4,0);
    drawRect(240 -4,0,4,160,0);
    drawRect(0,0,240,2,((0) | (19)<<5 | (31)<<10));
    drawRect(0,0,2,160,((0) | (19)<<5 | (31)<<10));
    drawRect(0,160 -2,240,2,((0) | (19)<<5 | (31)<<10));
    drawRect(240 -2,0,2,160,((0) | (19)<<5 | (31)<<10));
    state = START;
    dead = 0;
    pts = 0;
    seed = 0;
...
void start() {
    ...
    if(((!(~oldButtons & (1<<4))) && (~buttons & ((1<<4)))) && dif == 10){
        drawString(45,120,"Easy",0);
        drawString(100,120,"Medium",((31) | (31)<<5 | (31)<<10));
        dif-=5;
    }
    else if(((!(~oldButtons & (1<<4))) && (~buttons & ((1<<4)))) && dif == 5){
        drawString(100,120,"Medium",0);
        drawString(170,120,"Hard",((31) | (31)<<5 | (31)<<10));
        dif-=5;
    }
    else if(((!(~oldButtons & (1<<4))) && (~buttons & ((1<<4)))) && dif == 0){
        drawString(45,120,"Easy",((31) | (31)<<5 | (31)<<10));
        drawString(170,120,"Hard",0);
        dif=10;
    }
    if(((!(~oldButtons & (1<<5))) && (~buttons & ((1<<5)))) && dif == 5){
        drawString(45,120,"Easy",((31) | (31)<<5 | (31)<<10));
        drawString(100,120,"Medium",0);
        dif+=5;
    }
    else if(((!(~oldButtons & (1<<5))) && (~buttons & ((1<<5)))) && dif == 0){
        drawString(100,120,"Medium",((31) | (31)<<5 | (31)<<10));
        drawString(170,120,"Hard",0);
        dif+=5;
    }
    else if(((!(~oldButtons & (1<<5))) && (~buttons & ((1<<5)))) && dif == 10){
        drawString(45,120,"Easy",0);
        drawString(170,120,"Hard",((31) | (31)<<5 | (31)<<10));
        dif=0;
    }
...
void goToPause() {
    fillScreen(((20) | (20)<<5 | (20)<<10));
    drawString(110,40,"Pause",0);
    drawString(60,70,"press START to resume",0);
    drawString(55,90,"press SELECT to restart",0);
    state = PAUSE;
}
void pause() {
    waitForVBlank();
...
void goToWin() {
    ...
    drawString(95,60,"You WON!",0);
    drawString(45,90,"press START to play again",0);
    state = WIN;
}
void win() {
    waitForVBlank();
